                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="openMacList">
                        <div class="navbar-nav">
                            <a class="nav-link white <?php if (!isset($_GET['classify'])) echo 'active'; ?>" href="/php/accessory.php">Tất cả</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'charger') echo 'active'; ?>" href="/php/accessory.php?classify=charger">Củ sạc</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'wire') echo 'active'; ?>" href="/php/accessory.php?classify=wire">Dây sạc</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'battery') echo 'active'; ?>" href="/php/accessory.php?classify=battery">Sạc dự phòng</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'airtag') echo 'active'; ?>" href="/php/accessory.php?classify=airtag">AirTag</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'case') echo 'active'; ?>" href="/php/accessory.php?classify=case">Ốp lưng</a>
                        </div>
                    </div>
                </div>
            </nav>
