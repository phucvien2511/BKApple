                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="openMacList">
                        <div class="navbar-nav">
                            <a class="nav-link white <?php if (!isset($_GET['classify'])) echo 'active'; ?>" href="/php/categories/iphone.php">Tất cả</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'iphone14') echo 'active'; ?>" href="/php/categories/iphone.php?classify=iphone14">iPhone 14</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'iphone13') echo 'active'; ?>" href="/php/categories/iphone.php?classify=iphone13">iPhone 13</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'iphone12') echo 'active'; ?>" href="/php/categories/iphone.php?classify=iphone12">iPhone 12</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'iphone11') echo 'active'; ?>" href="/php/categories/iphone.php?classify=iphone11">iPhone 11</a>
                        </div>
                    </div>
            </nav>
