                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="openMacList">
                        <div class="navbar-nav">
                            <a class="nav-link white <?php if (!isset($_GET['classify'])) echo 'active'; ?>" href="/php/sound.php">Tất cả</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'airpod') echo 'active'; ?>" href="/php/sound.php?classify=airpod">AirPods</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'earpod') echo 'active'; ?>" href="/php/sound.php?classify=earpod">EarPods</a>
                        </div>
                    </div>
                </div>
            </nav>
