...
<?php
    ...
    if ($number_of_product == 0) {
        echo "<tr>"; 
        echo "<td colspan='7'>Không tồn tại sản phẩm</td>";
        echo "</tr>"; 
        return;
    } else {
        echo "<tr>"; 
        echo "<td colspan='7'>Có tất cả {$number_of_product} sản phẩm</td>";
        echo "</tr>"; 
    }
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>";
        echo "<a href='./viewProduct.php?product_id={$rows['id']}' class='btn btn-dark'><span class='material-symbols-outlined'>pageview</span></a>";
        echo "<a href='./editProductView.php?product_id={$rows['id']}' class='btn btn-dark'><span class='material-symbols-outlined'>edit</span></a>";
