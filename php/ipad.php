                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse text-center text-sm-start" id="openMacList">
                        ...
                        <div class="navbar-nav">
                            <a class="nav-link white <?php if (!isset($_GET['classify'])) echo 'active'; ?>" href="/php/ipad.php">Tất cả</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'pro-m1') echo 'active'; ?>" href="/php/ipad.php?classify=pro-m1">iPad Pro M1</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'pro-m2') echo 'active'; ?>" href="/php/ipad.php?classify=pro-m2">iPad Pro M2</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'air') echo 'active'; ?>" href="/php/ipad.php?classify=air">iPad Air</a>
                            <a class="nav-link white <?php if (isset($_GET['classify']) && $_GET['classify'] == 'mini') echo 'active'; ?>" href="/php/ipad.php?classify=mini">iPad Mini</a>
                        </div>
                    </div>
                </div>
            </nav>
