                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse text-center text-sm-start" id="openMacList">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link white" href="/php/ipad.php?classify=pro-m2">iPad Pro M2</a>
                            <a class="nav-link white" href="/php/ipad.php?classify=air">iPad Air</a>
                            <a class="nav-link white" href="/php/ipad.php?classify=mini">iPad Mini</a>
                        </div>
                    </div>
                </div>
            </nav>
