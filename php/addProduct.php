    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="content d-flex flex-column flex-shrink-0 p-3 text-white col-8 container">
                ...
                <div class="row">
                    <form class="g-3 needs-validation" method="post" action="./addProductControler.php" enctype="multipart/form-data" novalidate>
                        <div class="col">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="productColorNumber">Màu sản phẩm</label>
                            </div>

                            <div class="row defaultColor" >
                                <div class="mb-3 col">
                                    <label for="defaultColor">Màu mặc định</label>
                                ...
                                <div class="mb-3 col">
                                    <label for="defaultColorthumbnail" class="form-label">Thumbnail mặc định</label>
                                ...
                                <div class="mb-3 col">
                                    <label for="defaultColorpicture" class="form-label">Ảnh nhỏ mặc định</label>
                            ...
                            <div class="row subColor1">
                                ...
                                <div class="mb-3 col">
                                    <label for="subColor1thumbnail" class="form-label">Thumbnail màu bổ sung 1</label>
                                    <input class="form-control" type="file" name="subColor1thumbnail" id="subColor1thumbnail">
                                </div>

                                <div class="mb-3 col">
                                    <label for="subColor1picture" class="form-label">Ảnh nhỏ màu bổ sung 1</label>
                            ...
                            <div class="row subColor2">
                                ...
                                <div class="mb-3 col">
                                    <label for="subColor2thumbnail" class="form-label">Thumbnail màu bổ sung 2</label>
                                    <input class="form-control" type="file" name="subColor2thumbnail" id="subColor2thumbnail">
                                </div>

                                <div class="mb-3 col">
                                    <label for="subColor2picture" class="form-label">Ảnh nhỏ màu bổ sung 2</label>
                            ...
                            <div class="row iphone">
                                <div class="col form-floating">
                                    <select class="form-select" name="classifyIPhone" id="classifyIPhone" aria-label="classifyIPhone">
                                        <option value="iphone12" Selected>iPhone 12</option>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-1">
                                    <a href="./productManager.php" class="btn btn-secondary">Hủy</a>
                                </div>
                                <div class="col-1">
