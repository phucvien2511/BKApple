        ...
        <div class="row">
            ...
            <div class="content d-flex flex-column flex-shrink-0 p-3 text-white col-8 container">
                <div class="navigation row">
                    <div class="col">
                        <a href="./userManager.php"><span class="material-symbols-outlined">arrow_back</span></a>
                        <span><h1><?php echo "{$rows['name']}"; ?></h1></span>
                    </div>
                </div>
                        ...
                        <table class="table">
                            <tbody>
                                <?php
                                    ...
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th scope='row'>Tên người dùng</th>";
