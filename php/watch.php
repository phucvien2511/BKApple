                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="openMacList">
                        <div class="navbar-nav">
                            <a class="nav-link white" href="/php/watch.php">Tất cả</a>
                            <a class="nav-link white" href="/php/watch.php?classify=ultra">Apple Watch Ultra</a>
                            <a class="nav-link white" href="/php/watch.php?classify=se">Apple Watch SE</a>
                        </div>
                    </div>
                </div>
            </nav>
