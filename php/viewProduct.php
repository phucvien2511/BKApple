        ...
        <div class="row">
            ...
            <div class="content d-flex flex-column flex-shrink-0 p-3 text-white col-8 container">
                <div class="navigation row">
                    <div class="col">
                        <a href="./productManager.php"><span class="material-symbols-outlined">arrow_back</span></a>
                        <span><h1><?php echo "{$rows['productName']}"; ?></h1></span>
                    </div>
                </div>
                ...
                <div class="main-content row">
                    <div class="col-5 picture-container">
                        ...
                        <div class="row picsmall-container">
                            <div class="col">
                                <?php 
                                    echo "<img id='thumbnailsmall1' src='..{$rows['thumbnail']}{$colorDefault}_small1.png' class='thumbnail' alt='ThumbnailSmall1'>";
                                ?>
                            </div>
                            <div class="col">
                                <?php 
                                    echo "<img id='thumbnailsmall2' src='..{$rows['thumbnail']}{$colorDefault}_small2.png' class='thumbnail' alt='ThumbnailSmall2'>";
                                ?>
                            </div>
                        </div>
                        <div class="row color">     
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="./editProductView.php?product_id=<?php echo "$product_id";?>" class="btn btn-dark">Chỉnh sửa</a>
                            </div>
                            <div class="col">
                ...
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>                        
                            <?php
                                $name_query = "SELECT * FROM review, customer WHERE review.customerId = customer.Id and review.productId = '$product_id';";
                                $result = mysqli_query($db_connect, $name_query);
