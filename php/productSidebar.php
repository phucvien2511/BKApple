            <div class="sidebar d-flex flex-column flex-shrink-0 p-3 col-2">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="./productManager.php" class="nav-link text-black link-secondary bg-white" aria-current="page">
                        <span class="material-symbols-outlined">phone_iphone</span>
                            Sản phẩm
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="./userManager.php" class="nav-link text-white link-secondary" >
