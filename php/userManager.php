        ...
        <div class="row">
            ...
            <div class="content d-flex flex-column flex-shrink-0 p-3 text-white col-8 container">
                <div class="navigation row">
                    ...
                    <div class="col-4">
                        <div class="input-group">
                            <input type="search" id="searchUser" class="form-control" placeholder="Search">
                ...
                <div class="filter row justify-content-end">
                    <div class="col-1">
                        <a href="./addUser.php" class="btn btn-secondary">Thêm</a>
                    </div>
                </div>
                <div class="list row">
                    <table class="table">
                        ...
                        <?php 
                            ...
                            if ($page > 1) {
                                for ($page_id = 1; $page_id <= $page; $page_id++) {
                                    if ($page_id == 1) echo "<li class='page-item'><a class='page-link active' href='./userManagement.php?page={$page_id}' id='page-{$page_id}'>{$page_id}</a></li>";
                                    else echo "<li class='page-item'><a class='page-link' href='./userManagement.php?page={$page_id}' id='page-{$page_id}'>{$page_id}</a></li>";
                                }
                            }
                        ?>
                    </ul>
